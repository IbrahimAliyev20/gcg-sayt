...
export default function MissionPage() {
  return (
    <div className="flex flex-col items-center py-16 px-4 md:px-8 lg:px-16 bg-background text-foreground">
      {/* Our Mission Section */}
      <section className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 w-full max-w-6xl mb-16">
        ...
        <div className="md:w-1/2 flex justify-center p-4">
          <Image
            ...
            width={500}
            height={272}
            className="rounded-lg shadow-lg object-cover w-full h-auto max-w-md md:max-w-full"
          />
        </div>
      </section>
