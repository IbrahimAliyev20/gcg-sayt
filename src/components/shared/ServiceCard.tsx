...
const ServiceCard = ({ icon, title, description }: ServiceCardProps) => {
  return (
    <div className="w-full flex flex-col space-y-3 sm:space-y-4">
      ...
      <p className="text-slate-500 text-sm sm:text-[14px] leading-relaxed flex-grow line-clamp-3">
        {description}
      </p>

      <Link href="#" className="flex justify-between items-center text-sky-600 font-semibold group w-full">
        <span>Ətraflı</span>
