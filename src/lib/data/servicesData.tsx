...
export const servicesData: Service[] = [
  {
    id: 1,
    slug: "intellectual-management-systems",
  ...
  {
    id: 5,
    slug: "electronic-navigation-systems",
  ...
  {
    id: 8,
    slug: "fuel-efficiency-solutions",
    icon: <Fuel size={28} />,
  ...
  {
    id: 9,
    slug: "crew-training-and-simulators",
    icon: <Users size={28} />,
  ...
  {
    id: 12,
    slug: "port-operations-optimization",
    icon: <Anchor size={28} />,
  ...
  {
    id: 15,
    slug: "offshore-platform-support",
    icon: <Drill size={28} />,
